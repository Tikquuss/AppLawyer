...
public class TypeAffaire implements Serializable{
    ...
    public TypeAffaire(String label) {
        this.label = label;
    }
    ...
    public static List<TypeAffaire> all() {
        return getDAO().all(TypeAffaire.class);
    }
    
    public static List<String> allTypesAff(){
